...
class Conversation(models.Model):
    ...
    contractor = models.ForeignKey(User, on_delete=models.CASCADE, related_name="contractor_conversations")
    created_at = models.DateTimeField(auto_now_add=True)

    def __str__(self):
        return f"Conversation between {self.client} and {self.contractor}"
